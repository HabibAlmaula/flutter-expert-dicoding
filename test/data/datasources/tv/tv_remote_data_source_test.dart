    ...
    test('should return list of Tv Model when the response code is 200',
      ...
      when(mockHttpClient.get(
        Uri.parse('$BASE_URL/tv/on_the_air?$API_KEY'),
          ...
          http.Response(readJson('dummy_data/tv_dummy/on_the_air.json'), 200));
      // act
    ...
    test('should return list of Tv when response is success (200)', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/popular?$API_KEY')))
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/tv_dummy/popular_tv.json'), 200));
      // act
  ...
  group('get Top Rated Tv', () {
    ...
    test('should return list of Tv when response code is 200 ', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/top_rated?$API_KEY')))
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/tv_dummy/top_rated_tv.json'), 200));
      // act
  ...
  group('get Tv recommendations', () {
    ...
    test('should return list of Tv Model when the response code is 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/tv_dummy/tv_recommendations.json'), 200));
      // act
  ...
  group('search Tv', () {
    ...
    test('should return list of Tv when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/tv_dummy/search_umbrella_tv.json'), 200));
      // act
