...
void main() {
  ...
  group('get now playing tv', () {
    test('initialState should be Empty', () {
      expect(homeTvBloc.state, HomeTvState().initialState());
    });
    ...
    blocTest<HomeTvBloc, HomeTvState>(
        ...
        expect: () => [
              ...
              HomeTvState().nowPlayingHasData(result: tTvList)
            ],
        verify: (bloc) {
    ...
    blocTest<HomeTvBloc, HomeTvState>(
        ...
        expect: () => [
              HomeTvState().nowPlayingLoading(),
              HomeTvState().nowPlayingError(message: 'Server Failure')
            ],
        verify: (bloc) {
          verify(() => mockGetNowPlayingTv.execute());
        });
  ...
  group('get popular Tv', () {
    ...
    blocTest<HomeTvBloc, HomeTvState>(
        ...
        expect: () => [
              ...
              HomeTvState().popularHasData(result: tTvList)
            ],
        verify: (bloc) {
    ...
    blocTest<HomeTvBloc, HomeTvState>(
        ...
        expect: () => [
              HomeTvState().popularLoading(),
              HomeTvState().popularError(message: 'Server Failure')
            ],
        verify: (bloc) {
          verify(() => mockGetPopularTv.execute());
        });
  ...
  group('get top rated Tv', () {
    ...
    blocTest<HomeTvBloc, HomeTvState>(
        ...
        expect: () => [
              ...
              HomeTvState().topRatedHasData(result: tTvList)
            ],
        verify: (bloc) {
    ...
    blocTest<HomeTvBloc, HomeTvState>(
        ...
        expect: () => [
              HomeTvState().topRatedLoading(),
              HomeTvState().topRatedError(message: 'Server Failure')
            ],
        verify: (bloc) {
          verify(() => mockGetTopRatedTv.execute());
        });
