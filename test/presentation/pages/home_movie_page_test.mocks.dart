...
import 'package:ditonton/data/models/screen_model.dart' as _i11;
...
class MockNavigationProvider extends _i1.Mock
  ...
  int get currentTabIndex =>
      (super.noSuchMethod(Invocation.getter(#currentTabIndex), returnValue: 0)
          as int);
  @override
  int get currentDataScreen =>
      (super.noSuchMethod(Invocation.getter(#currentDataScreen), returnValue: 0)
          as int);
  @override
  List<int> get listTabActive => (super
          .noSuchMethod(Invocation.getter(#listTabActive), returnValue: <int>[])
      as List<int>);
  @override
  List<_i11.Screen> get screens =>
      (super.noSuchMethod(Invocation.getter(#screens),
          returnValue: <_i11.Screen>[]) as List<_i11.Screen>);
  @override
  bool get hasListeners =>
      (super.noSuchMethod(Invocation.getter(#hasListeners), returnValue: false)
          as bool);
  ...
  void setDataScreen(int? data) =>
      super.noSuchMethod(Invocation.method(#setDataScreen, [data]),
          returnValueForMissingStub: null);
  @override
  void setTab(int? tab) => super.noSuchMethod(Invocation.method(#setTab, [tab]),
      returnValueForMissingStub: null);
  @override
  _i8.Future<bool> onWillPop(_i12.BuildContext? context) =>
      (super.noSuchMethod(Invocation.method(#onWillPop, [context]),
