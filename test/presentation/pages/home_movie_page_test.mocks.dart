...
import 'package:ditonton/common/app_enum.dart' as _i7;
...
class MockNavigationProvider extends _i1.Mock
  ...
  @override
  int get currentTabIndex => (super.noSuchMethod(
        Invocation.getter(#currentTabIndex),
        returnValue: 0,
      ) as int);
  @override
  int get currentDataScreen => (super.noSuchMethod(
        Invocation.getter(#currentDataScreen),
        returnValue: 0,
      ) as int);
  @override
  List<int> get listTabActive => (super.noSuchMethod(
        Invocation.getter(#listTabActive),
        returnValue: <int>[],
      ) as List<int>);
  @override
  List<_i11.Screen> get screens => (super.noSuchMethod(
        Invocation.getter(#screens),
        returnValue: <_i11.Screen>[],
      ) as List<_i11.Screen>);
  @override
  bool get hasListeners => (super.noSuchMethod(
        Invocation.getter(#hasListeners),
  ...
  @override
  void setDataScreen(int? data) => super.noSuchMethod(
        Invocation.method(
          #setDataScreen,
          [data],
        ),
  ...
  @override
  void setTab(int? tab) => super.noSuchMethod(
        Invocation.method(
          #setTab,
          [tab],
        ),
  ...
  @override
  _i8.Future<bool> onWillPop(_i12.BuildContext? context) => (super.noSuchMethod(
        Invocation.method(
          #onWillPop,
          [context],
        ),
